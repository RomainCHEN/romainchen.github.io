...
export const ieltsCoach: Project = {
  ...
  blurb: {
    ...
    zh: '一个面向雅思口语和写作的开源 agent skill，出发点是：你记不住的范文，等于没有。',
  },
  ...
  sections: [
    {
      ...
      body: {
        ...
        zh: [
          '找任何一个助手要一篇雅思作文，四秒钟就能拿到 250 个通顺的英文词。Firstly、Secondly、In conclusion。它在机器读的评分表上分数不低，可它会害了考生，原因只有一个：考场上你只调得出属于自己的东西。',
    ...
    },
    {
      ...
      caption: {
        ...
        zh: '产出的是一份可打印的文档，不是一段聊天记录。几个月后还能翻出来复习，而备考真正在意的就是这个时间尺度。',
      },
    },
    {
      kind: 'evidence',
      ...
      intro: {
        ...
        zh: [
          '这是一个已经发布、能用的工具，设计论证站得住，但没有任何证据说明它能提分。我不打算装作有。而且诚实的版本反而更有用，因为它顺带说清了什么样的研究才能给出结论。',
        ],
      },
      items: [
        {
        ...
        },
        {
          ...
          detail: {
            ...
            zh: '没测过。设计借用了关于个人相关性和生成效应的成熟观点，但借来一个理由不等于有证据。最省钱又有信息量的做法，是用被试内设计比一比“自己出的素材”和“模型出的素材”哪个记得更牢。这个实验还没做。',
          },
        },
        {
          ...
          detail: {
            ...
            zh: '仓库文档把被识别的风险写成“接近零”。那是设计意图，不是测量结果；要我在这个说法和撤掉它之间选，我会撤掉。拿真实检测器去测很容易，只是还没做。',
          },
        },
      ],
    },
