...
export const ABOUT_LEDE: Paragraphs = {
  ...
  zh: [
    ...
    '这几年两边的课都会讲到同一件事：机器已经能做我们正在学的这些了。可再追一句，那人还剩什么，两边就都答不清楚。更麻烦的是，万一这份东西哪天真没了，我们大概也察觉不到。',
  ],
};
  ...
  },
  {
    ...
    body: {
      ...
      zh: [
        ...
        '需要的时候我也能一个人把整套东西做完，登录鉴权、数据库结构、带类型修复的模型路由、导出 Word 和 PDF、上线部署。会全栈本身没什么了不起，可工具要是没人用得起来就一条数据也采不到，这才是我非得自己动手的原因。',
...
export const COLOPHON: Paragraphs = {
  ...
  zh: [
    '本站用 Next.js 静态构建，GitHub Actions 部署，没有统计脚本，不向第三方发请求，也就不需要 cookie 提示。标题和正文排的是 Newsreader，界面文字用 Instrument Sans，数据用 IBM Plex Mono。',
  ],
};
