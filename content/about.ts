...
export const ABOUT_LEDE: Paragraphs = {
  ...
  zh: [
    ...
    '这三年里，两个专业都被反复告知：机器已经能做我们花四年学的那件事了。可紧接着的问题，两边都答不好。人到底还剩下什么贡献？万一这份贡献真的没了，你凭什么发现？',
  ],
};
...
export const ABOUT_BODY: { heading: L; body: Paragraphs }[] = [
  ...
  },
  {
    ...
    body: {
      ...
      zh: [
        '我想继续待在这三个项目共同指向的位置上：做能让“人的贡献”显形的工具，然后真去做那些检验设计对不对的研究。我缺的是把后半段做扎实的训练，也就是测量、实验设计，以及在样本量足以让统计量说得上话的规模上做学习分析。',
