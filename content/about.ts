...
export const ABOUT_BODY: { heading: L; body: Paragraphs }[] = [
  {
    ...
    body: {
      ...
      zh: [
        ...
        '这种抱怨每个老师都会有，本身不值一提。可后来我慢慢想明白，我更想弄清楚**那两个小时里，哪些判断只有我能做**，哪些模型也能替我做。这件事本来是测得出来的，偏偏几乎没人测。后来我干脆做了个工具，专门把这个答案记下来。',
  ...
  },
  {
    ...
    body: {
      ...
      zh: [
        '三个项目其实指着同一个位置，我想继续待在那儿，一边做能把人的贡献记录下来的工具，一边真去跑研究，看设计到底站不站得住。我欠的是后半段的训练：测量怎么做、实验怎么设计、样本量够大之后该怎么分析。',
        '我作品集里最缺的是证据。系统做出来了，研究方案也写好了，可一次都还没真跑过。这一块我最想补上，也是我想去读研而不是继续做产品的原因。',
      ],
    },
  },
];
