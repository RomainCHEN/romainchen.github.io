...
None of these is a speed problem. Two of them are measurement problems and one is a motivation problem.
...
Whether any of this works. The instruments are built and the study is written — task timing against each teacher's own manual baseline, a usability scale, a workload scale, a content-quality rubric, interviews — and I have not run it.
